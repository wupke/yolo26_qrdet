#!/usr/bin/env python3
"""
FilePath: /ultralytics/qrdet/check-detDecodeQrRos-distanceLidar9.py
author: wupke
Date: 2026-02-06 13:49:02
Version: 1.0
LastEditors: wupke
LastEditTime: 2026-02-06 16:27:55
Description:
...
[ERROR] [1770364309.155594]: bad callback: <bound method Subscriber.callback of <message_filters.Subscriber object at 0xffff96969120>>
Traceback (most recent call last):
  ...
  File "/opt/ros/noetic/lib/python3/dist-packages/message_filters/__init__.py", line 58, in signalMessage
    cb(*(msg + args))
  File "/home/nvidia/01yuyao/ultralytics/scripts/check-detDecodeQrRos-distanceLidar8.py", line 110, in callback
    data, bbox, _ = self.detector.detectAndDecode(frame)
cv2.error: OpenCV(4.10.0) /io/opencv/modules/objdetect/src/qrcode.cpp:2951: error: (-2:Unspecified error) in function 'virtual std::string cv::ImplContour::decode(cv::InputArray, cv::InputArray, cv::OutputArray) const'
