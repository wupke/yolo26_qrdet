...
# -*- coding: utf-8 -*-
'''
FilePath: /ultralytics/qrdet/check-detDecodeQrRos-distanceLidar10.py
author: wupke
Date: 2026-02-06 16:28:07
Version: 1.0
LastEditors: wupke
LastEditTime: 2026-02-09 09:07:39
Description:       
...
'''
相比于 check-detDecodeQrRos-distanceLidar9.py ， 更改 callback() ：

✅ 不要用 detectAndDecode()
✅ 改成 detect + decode 分离 + bbox 校验


- 待测试通过 时间：2026-02-06 16:33:18
...
- 连续 N 帧 decode 成功才 valid=True

- QR bbox 面积自适应阈值（随距离变化）
